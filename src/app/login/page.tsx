...
import { Button } from "@/components/ui/button"; // We need to install button component
        ...
        <div className="flex h-screen w-full flex-col items-center justify-center bg-zinc-950 text-white">
            <div className="flex flex-col items-center space-y-6 text-center">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-zinc-400">Entre para gerenciar seu patrimônio</p>
                </div>

                <button
                    onClick={signIn}
                    className="flex items-center gap-3 rounded-lg bg-white px-6 py-3 font-medium text-black transition-transform hover:scale-105 active:scale-95"
                >
